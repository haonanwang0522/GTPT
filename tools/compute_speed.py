...
def compute_fps(model, inputs, N=1000):
...
def compute_throughput(model, inputs, ntest=1000):
...
def compute_memory(model, inputs, ntest=1):
    ...
    print("Memory ", memory / 1024 / 1024, "M")
    return memory
